defmodule NeGorchitBackendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeGorchitBackendWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeGorchitBackendWeb.Gettext, "errors", msg, opts)
    end
  end
